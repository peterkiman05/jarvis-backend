...
@app.get("/")
def home():
    return {"status": "JARVIS Financial Core Online"}

@app.get("/market/gold/analytics")
def get_gold_analytics():
    """Fetches XAU/USD data and calculates RSI, EMA 20, and EMA 50."""
    try:
        # Pull 5-day history with 15m intervals for technical indicators
        ...
        if df.empty or len(df) < 50:
            return {"error": "Insufficient market data available for analytics."}
